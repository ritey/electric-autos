	...
	<div class="container mx-auto">
			...
			<div class="row">
				...
				<div class="col-sm-12">
					...
					<p>Web beacons are tiny graphics with a unique identifier and are used to track the online movements of internet users. Unlike cookies, which are stored on a user’s computer hard drive, web beacons are embedded invisibly on websites.</p>
					...
					These could set cookies or track your activity anonymously – for full information you should read the privacy policies of these sites.</p>
					...
					<p>You can choose to disable your web browser’s ability to accept cookies.<br>
					Please note that if you do elect to disable your web browser’s ability to accept cookies, you may not be able to access or take advantage of many features of the service and some parts of the website may not work properly.</p>
